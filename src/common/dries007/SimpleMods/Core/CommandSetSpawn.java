...
public class CommandSetSpawn extends CommandBase
{
    ...
    public void processCommand(ICommandSender sender, String[] args)
    {
    	...
    	else
    	{
    		...
    		NBTTagCompound rankdata = Permissions.rankData.getCompoundTag(rank);
			...
			Permissions.rankData.setCompoundTag(rank, rankdata);
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args)
    {
    	...
    	Iterator warpsIt = Permissions.rankData.getTags().iterator();
